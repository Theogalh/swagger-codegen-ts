# [2.0.0-alpha.27](https://github.com/devexperts/swagger-codegen-ts/compare/v2.0.0-alpha.26...v2.0.0-alpha.27) (2022-01-07)

### Features

* **oas3:** Support bigint for Integer with format int64

### BREAKING CHANGES

* **oas3:** SERIALIZED_INTEGER_TYPE is now used by new function getSerializedIntegerType with optional format in first parameter for default Integer and int32 value
